    ...
    return(
        ...
        <div className="grid grid-cols-12 gap-4 mt-4 mb-4 items-center">
            <div className="col-span-5 flex items-center">
                <img className="w-12 h-12 rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTdmrjoiXGVFEcd1cX9Arb1itXTr2u8EKNpw&s"/>
                <div className="ml-5">
            ...
            <div className="col-span-2">
                <div className={`inline-flex items-center px-4 py-1 text-sm rounded-full font-semibold ${getColor(role)}`}>
                    {role}
                </div>
            </div>
            <h1 className="col-span-2 text-gray-500">{phone}</h1>

            <div className="col-span-1 p-0 rounded hover:bg-gray-100 relative"
